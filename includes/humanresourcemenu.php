...
<div class="content hidden-xs">
    ...
    <section class="left-men inner-left-men">
                    ...
                    <div class="col-md-">
                        <a href="addemployee.php">
                            <div class="menu-cos" id="menu11">
                                <h3><i class="fa fa-user"></i> <span>Add Employee</span>  <span class="coshrt">B</span></h3>
                            </div>
                        </a>
                    </div>
                    <div class="col-md-">
                        <a href="viewemployees.php">
                            <div class="menu-cos" id="menu33">
                                <h3><i class="fa fa-users"></i> <span>View Employees</span> <span class="coshrt">C</span></h3>
                            </div>
                        </a>
                    </div>
